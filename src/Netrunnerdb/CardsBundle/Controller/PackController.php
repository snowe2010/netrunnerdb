...
use Netrunnerdb\CardsBundle\Form\PackType;
...
class PackController extends Controller
{
    ...
    public function indexAction()
    {
        ...
        $entities = $em->getRepository('NetrunnerdbCardsBundle:Pack')->findAll();

        return $this->render('NetrunnerdbCardsBundle:Pack:index.html.twig', array(
            'entities' => $entities,
        ));
    }
    /**
    ...
    public function createAction(Request $request)
    {
        ...
        return $this->render('NetrunnerdbCardsBundle:Pack:new.html.twig', array(
            'entity' => $entity,
    ...
    public function showAction($id)
    {
        ...
        $entity = $em->getRepository('NetrunnerdbCardsBundle:Pack')->find($id);
        ...
        return $this->render('NetrunnerdbCardsBundle:Pack:show.html.twig', array(
            'entity'      => $entity,
    ...
    public function editAction($id)
    {
        ...
        return $this->render('NetrunnerdbCardsBundle:Pack:edit.html.twig', array(
            'entity'      => $entity,
